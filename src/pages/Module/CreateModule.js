  ...
  return (
    ...
    <div className="page-content">
        <Container fluid={true}>
            <Breadcrumbs maintitle="Towner" title="Module" breadcrumbItem="Create Module" />
            <Row>
                <Col>
                    <Card>
                        <CardBody>
                            <CardTitle className="h4">Create Module </CardTitle>
        ...
        <Modal isOpen={modal_center} toggle={tog_center} size="xl">
                        <ModalHeader className="mt-0" toggle={tog_center}>Add Field</ModalHeader>
                        <ModalBody>
                          <AddField/>
                        </ModalBody>
                        <ModalFooter>
