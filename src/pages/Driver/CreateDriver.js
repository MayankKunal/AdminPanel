        ...
        <>
            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumbs maintitle="Towner" title="Driver" breadcrumbItem="Add Driver" />
                    <Row>
                        <Col>
                            <Card>
                                <CardBody>
                                    <CardTitle className="h4 text-center"><h1>Add Driver</h1> </CardTitle>
                    ...
                    <code>type</code>.
                                    ...
                                    <form>
                                        ...
                                        <Col lg="4">
                                            ...
                                            <Col lg="4">
                                            <div className="mb-6">
                                                    <label className="form-label" htmlFor="city">Service City</label>{" "}
                                                    <input type="text" className="form-control" id="city" placeholder='Enter Driver Service  City'  />
                                                </div>
                                            </Col>
                                        </Row>
                                        <Row>
                                        <Col lg="4">
                                            <div className="mb-6">
                                                    <label className="form-label" htmlFor="password">Driver Password</label>{" "}
                                                    <input type="password" className="form-control" id="password" placeholder='Enter Driver Password' />
                                                </div>
                                            </Col>
                                        <Col lg="4">
                                                <div className="mb-6">
