        ...
        <>
            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumbs maintitle="Towner" title="Channel Partner" breadcrumbItem="Create Channel Partner" />
                    <Row>
                        <Col>
                            <Card>
                                <CardBody>
                                    <CardTitle className="h4 text-center"><h1>Create ChannelPartner</h1> </CardTitle>
