    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs maintitle="Towner" title="Role" breadcrumbItem="Edit Role" />

          <Row>
            <Col>
              <Card>
                <CardBody>
                  <CardTitle className="h4">Edit Role and Select one or Permissions for thr roles</CardTitle>
